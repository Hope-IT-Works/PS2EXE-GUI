...
function Invoke-PS2EXE {
    ...
    #>
    @('prepareDebug','noConsole','UNICODEEncoding','credentialGUI','configFile','noOutput','noError','noVisualStyles','exitOnCancel','DPIAware','requireAdmin','supportOS','virtualize','longPaths') | ForEach-Object {
